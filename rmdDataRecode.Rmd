...
# indexPayment
PAY_PCA = prcomp(data.frame(dataKZ$ALLCARDS[20:86],
                     dataKZ$TERMIN1[20:86], dataKZ$ATM[20:86]), scale = T, center = T)
biplot(PAY_PCA)
dataKZ$indexPayment = c(rep(NA, 19), PAY_PCA$x[,1], rep(NA, 1))

# indexDemocracy!!!
INST_PCA = prcomp(data.frame(dataKZ$GI[28:80], dataKZ$PV[28:80], dataKZ$PRR[28:80], dataKZ$GE[28:80]), center = T, scale = T)
biplot(INST_PCA)
